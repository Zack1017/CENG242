...
HD_PWD='/home/student/s101113328/CENG242/Lab3/Lab3/Lab3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log generic_shifter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source generic_shifter.tcl -notrace
