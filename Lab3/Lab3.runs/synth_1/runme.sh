...
HD_PWD='/home/student/s101113328/CENG242/Lab3/Lab3/Lab3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log generic_shifter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source generic_shifter.tcl
