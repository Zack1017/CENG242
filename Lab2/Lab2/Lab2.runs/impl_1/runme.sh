...
HD_PWD='/home/student/s101113328/CENG242/Lab2/Lab2/Lab2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log adder_6bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source adder_6bit.tcl -notrace
