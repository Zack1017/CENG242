...
HD_PWD='/home/student/s101113328/CENG242/Lab2/Lab2/Lab2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log adder_6bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source adder_6bit.tcl
